            ...
            <div className="relative z-10 container mx-auto px-4 py-16 sm:py-24 md:py-32">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    <div className="relative w-full max-w-2xl">
                        <div className="flex items-center bg-white dark:bg-gray-800 rounded-full shadow-xl border border-gray-100 dark:border-gray-700 p-2 transition-all hover:shadow-purple-100 dark:hover:shadow-purple-900/20">
