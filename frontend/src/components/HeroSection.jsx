...
const HeroSection = () => {
    ...
    // console.log(searchedJobs,"check in hero section");
   ...
   async function searchJob(){
    ...
    try {
        ...
        console.log(res.data.success,"check");

        if(res.data.success){
        //    console.log(res.data.jobs,"check in search job")
                ...
                <div className="relative z-10 container mx-auto px-4 py-16 sm:py-24 md:py-32">
                    <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                        ...
                        <div className="relative w-full max-w-2xl">
                            <div className="flex items-center bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-3 transition-all hover:shadow-lg hover:shadow-purple-300 dark:hover:shadow-purple-900/30">
