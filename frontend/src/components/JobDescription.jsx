          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                >
                  <span className="h-3.5 w-3.5 mr-1 text-emerald-800 text-sm leading-none">
                    ₹
                  </span>
                  {getSalaryDisplay()}
                </Badge>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 group">
                <div className="p-3 bg-emerald-100 rounded-full group-hover:bg-emerald-200 transition-colors">
                  <span className="h-5 w-5 text-emerald-600 text-xl leading-none">
                    ₹
                  </span>
                </div>
                <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    {formatDate(singleJob?.postedDate || singleJob?.createdAt)}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3 group">
