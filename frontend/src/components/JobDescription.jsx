...
const JobDescription = () => {
    ...
    const getSalaryDisplay = () => {
        if (singleJob?.salaryRangeDiversity?.min && singleJob?.salaryRangeDiversity?.max) {
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center mt-2">
                        Thank you for your interest! Your application has been successfully submitted. The hiring team will review your profile soon.
                    </DialogDescription>
                </DialogHeader>
        ...
        <div className="max-w-7xl mx-auto my-10 px-4 sm:px-6 lg:px-8">
            <Card className="shadow-xl border-none overflow-hidden bg-gradient-to-b from-white to-slate-50">
                ...
                <CardContent className="pt-6">
                    <h2 className="text-xl font-semibold pb-2 mb-6 text-gray-800 border-b border-gray-200">Job Details</h2>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">
                                        {singleJob?.workLocation?.city || singleJob?.location || 'N/A'}
                            ...
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{singleJob?.jobType || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{singleJob?.workplacePlane || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{singleJob?.experienceLevel || 'N/A'}</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-5">
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{singleJob?.vacancies || singleJob?.position || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{formatDate(singleJob?.postedDate || singleJob?.createdAt)}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{formatDate(singleJob?.deadline)}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">{singleJob?.jobCategory || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-700">Education Level</h3>
                                    <p className="text-gray-600 mt-1">{singleJob?.educationLevel || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 group">
                    ...
                    <div className="mt-8 space-y-6">
                        ...
                        <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                            <h3 className="font-semibold text-lg mb-4 text-gray-800">Skills</h3>
                            <div className="flex flex-wrap gap-2">
                                {singleJob?.skills?.length > 0 ? (
                                    singleJob.skills.map((skill, index) => (
                                        <Badge key={index} variant="outline" className="bg-indigo-100 text-indigo-800 px-3 py-1">
                                            {skill}
                                        </Badge>
                                    ))
                                ) : (
                        ...
                        <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                            <h3 className="font-semibold text-lg mb-4 text-gray-800">Availability Frame</h3>
                            <p className="text-gray-700">
                                <strong>Start:</strong> {formatDate(singleJob?.availabilityFrame?.startDate)} <br />
                                <strong>End:</strong> {formatDate(singleJob?.availabilityFrame?.endDate)}
                            </p>
                        </div>
                        <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
                            <h3 className="font-semibold text-lg mb-4 text-gray-800">Keywords</h3>
                            <div className="flex flex-wrap gap-2">
                                {singleJob?.keywords?.length > 0 ? (
                                    singleJob.keywords.map((keyword, index) => (
                                        <Badge key={index} variant="outline" className="bg-gray-100 text-gray-800 px-3 py-1">
                                            {keyword}
                                        </Badge>
                                    ))
                                ) : (
