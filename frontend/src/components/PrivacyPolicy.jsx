      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-xl text-gray-600 mt-4 max-w-lg">
              Every human or organization has three levels of openness: Public, Personal, and Private. 
            ...
            <div className="md:col-span-1">
              <div className="sticky top-8">
                ...
                <ul className="space-y-2">
                  {['Introduction', 'Scope', 'Definitions', 'Information Collection', 'Data Sharing', 'Data Security', 'Your Rights'].map((item) => (
                    <li key={item}>
                      <a 
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  <h4 className="text-md font-semibold text-blue-800">Need Help?</h4>
                  <p className="text-sm text-gray-600 mt-2">
                    For any privacy-related questions, contact us at:
                  </p>
                  <a href="mailto:help@makeyourjobs.com" className="text-blue-600 hover:text-blue-800 text-sm font-medium mt-1 block">
            ...
            <div className="md:col-span-2 space-y-8">
              <section id="introduction">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3  items-center justify-center text-sm">1</span>
                  Introduction
                </h2>
              ...
              <section id="scope">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 flex items-center justify-center text-sm">2</span>
                  Scope
                </h2>
              ...
              <section id="definitions">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3  items-center justify-center text-sm">3</span>
                  Definitions
                </h2>
                <div className="text-gray-700 space-y-4 pl-11">
                  <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
                    <p className="font-medium">Opportunities</p>
                    <p className="text-sm">Public and private competitions, quizzes, hackathons, events, scholarships, jobs, and more hosted on the Platform.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-green-500">
                    <p className="font-medium">Clients</p>
                    <p className="text-sm">Companies, institutes, and organizations using the Platform to host events and hire candidates.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500">
                    <p className="font-medium">Participants</p>
                    <p className="text-sm">Individuals who register and participate in opportunities on the Platform.</p>
                  </div>
                </div>
              </section>
              ...
              <section id="information-collection">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 flex items-center justify-center text-sm">4</span>
              ...
              <section id="data-sharing">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 flex items-center justify-center text-sm">5</span>
                  Data Sharing
                </h2>
                <div className="text-gray-700 pl-11">
                  <p>
              ...
              <section id="data-security">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 flex items-center justify-center text-sm">6</span>
                  Data Security
                </h2>
                <div className="text-gray-700 pl-11">
                  <p>
              ...
              <section id="your-rights">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 flex items-center justify-center text-sm">7</span>
                  Your Rights
                </h2>
                <div className="text-gray-700 pl-11">
                  <p>
                    You have the right to access, update, or delete your data. For any inquiries, contact us at{" "}
                    <a href="mailto:help@makeyourjobs.com" className="text-blue-600 hover:text-blue-800 font-medium">
                      help@makeyourjobs.com
                    </a>.
                  </p>
                </div>
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-lg p-8 text-white text-center">
          ...
          <p className="text-lg mb-6 max-w-2xl mx-auto">
            If you have any questions about our privacy practices, please don't hesitate to reach out to our team.
          </p>
          <a 
