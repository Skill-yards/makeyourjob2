...
const UpdateProfileDialog = ({ open, setOpen, croppedImage }) => {
  ...
  const submitHandler = async (e) => {
    ...
    // Add the cropped profile image if available
    if (croppedImage) {
      // Convert base64 to file if croppedImage is a base64 string
        ...
        <form onSubmit={submitHandler} className="space-y-6">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="text-sm text-gray-500">
              {croppedImage ? 'New profile photo selected' : 'Current profile photo'}
            </div>
          </div>
